...
{
	SnowDemo * demo = new SnowDemo(class_name);
	return reinterpret_cast<GLApplication *>(demo);
}


/** 构造函数 */
SnowDemo::SnowDemo(const char * class_name) : GLApplication(class_name)
{
  /// 初始化用户自定义的程序变量
	m_Fps = 0;
	m_RotAngle = 0.0;
...
/** 用户自定义的卸载函数 */
void SnowDemo::Uninit()	
{
}

/** 程序更新函数 */
void SnowDemo::Update(DWORD milliseconds)						
{
...
/** 计算帧速 */
void SnowDemo::CaculateFrameRate()
{
