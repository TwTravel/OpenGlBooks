...
void CChessGame::SetupWhitePieces()
{
	...
	m_pieces[8].m_col = 0; m_pieces[9].m_col = 7;
	m_pieces[8].m_row = 0;	m_pieces[9].m_row = 0;
	...
	m_pieces[10].m_col = 1; m_pieces[11].m_col = 6;
	m_pieces[10].m_row = 0; m_pieces[11].m_row = 0;
	...
	m_pieces[12].m_col = 2; m_pieces[13].m_col = 5;
	m_pieces[12].m_row = 0; m_pieces[13].m_row = 0;
...
void CChessGame::SetupBlackPieces()
{
	...
	m_pieces[24].m_col = 0; m_pieces[25].m_col = 7;
	m_pieces[24].m_row = 7; m_pieces[25].m_row = 7;
	...
	m_pieces[26].m_col = 1; m_pieces[27].m_col = 6;
	m_pieces[26].m_row = 7; m_pieces[27].m_row = 7;
	...
	m_pieces[28].m_col = 2; m_pieces[29].m_col = 5;
	m_pieces[28].m_row = 7; m_pieces[29].m_row = 7;
