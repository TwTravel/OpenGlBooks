...
public:
	...
	// set this vector as 
    inline void setAdd(const GLVector3& v1, const GLVector3& v2)
    {   set( v1.x + v2.x, v1.y + v2.y, v1.z + v2.z );  }

	// Set this vector as the subtraction of v1 from v2
    inline void setSub(const GLVector3& v1, const GLVector3& v2)
    {   set( v1.x - v2.x, v1.y - v2.y, v1.z - v2.z );  }

	// Set this vector as the scalar multiplicaiton of v
    inline void setMultiply( const GLVector3& v, float f )
    {   set( v.x * f, v.y * f, v.z * f );  }

	// Set this vector as the (v1 * f) + v2
    inline void setMultiplyAdd(const GLVector3& v1, float f, const GLVector3& v2)
    {   set( (v1.x * f) + v2.x, (v1.y * f) + v2.y, (v1.z * f) + v2.z );  }
	
	// set this vecotr as the linearly interpollated v1 and v2 according to parameter t
    inline GLVector3& setLerp(const GLVector3& v1, const GLVector3& v2, T t)
    {   setSub( v2, v1 );	
		(*this) *= t;	
		(*this) += v1;  
        return *this;
    ...
    //!Apply the cross-product of this and a vector
    GLVector3& setCross(const GLVector3& v1, const GLVector3& v2 )
    {
...
public:
	...
	void zero(){ set( 0.0, 0.0, 0.0, 0.0 ); };
	bool iszero(){ return (x==0.0 && y==0.0 && z==0.0 && w==0.0 ); };
	...
	// set this vector as 
    inline void setAdd(const GLVector4& v1, const GLVector4& v2)
    {   set( v1.x + v2.x, v1.y + v2.y, v1.z + v2.z );  }

	// Set this vector as the subtraction of v1 from v2
    inline void setSub(const GLVector4& v1, const GLVector4& v2)
    {   set( v1.x - v2.x, v1.y - v2.y, v1.z - v2.z, v1.w - v2.w );  }

	// Set this vector as the scalar multiplicaiton of v
    inline void setMultiply( const GLVector4& v, float f )
    {   set( v.x * f, v.y * f, v.z * f, v.w * f );  }

	// Set this vector as the (v1 * f) + v2
    inline void setMultiplyAdd(const GLVector4& v1, float f, const GLVector4& v2)
    {   set( (v1.x * f) + v2.x, (v1.y * f) + v2.y, (v1.z * f) + v2.z, (v1.w * f) + v2.w );  }
	
	// linearly interpolate and then normalize.
	inline GLVector4& setLerp(GLVector4 v1, GLVector4 v2, T t)
	{
		setSub( v2, v1 );
		setMultiplyAdd( *this, t, v1 );
	//	this *= t;
	//	this += v1;
		return (*this);
	}
