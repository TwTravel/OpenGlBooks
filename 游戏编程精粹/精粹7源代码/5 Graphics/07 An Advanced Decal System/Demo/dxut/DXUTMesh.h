...
//-----------------------------------------------------------------------------
// Name: class CDXUTMeshTexture
// Desc: Texture mapping
//-----------------------------------------------------------------------------
class CDXUTMeshTexture
{
public:
    CHAR                    m_strName[512];
...
//-----------------------------------------------------------------------------
// Name: class CDXUTMeshMaterial
// Desc: Contains additional textures
//-----------------------------------------------------------------------------
class CDXUTMeshMaterial
{
public:
    D3DMATERIAL9            m_d3dMaterial;
    CGrowableArray< CDXUTMeshTexture > m_Textures;
};
...
public:
    ...
    CDXUTMeshMaterial *     m_pMaterials;
...
public:
    ...
    void    UseShaderTextures( bool bFlag ) { m_bUseShaderTextures = bFlag; }
    ...
    HRESULT CreateMaterials( LPCWSTR strPath, IDirect3DDevice9 *pd3dDevice, D3DXMATERIAL* d3dxMtrls, DWORD dwNumMaterials, D3DXEFFECTINSTANCE* pShaderData );
    HRESULT Destroy();
